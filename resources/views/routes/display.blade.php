...
<table class="map_pageTable">
	<tr>
		...
		<td class="map_menuCell">
			...
			<div class="leftmenu_item_con">
				<a class="buttonLink" href="{{ Route( 'routes') }}">{{ __("Back to
					routes overview") }}</a>
			</div> @endif
		</td>
...
\App\Lib\Page::topMenuitem('routes.edit', [
    'id' => $id
], __("Edit route"));
\App\Lib\Page::topMenuitem('routes.trace.edit', [
    'id' => $id
], __("Upload new gpx file"));
\App\Lib\Page::topMenuitemConfirm('routes.del', [
    'id' => $id
], __("Delete this route"), __("Delete route?"));
...
<div class="map_container">
				<table class="map_table">
					<tr>
						<td class="map_title">{{ $route->title }}</td>
					</tr>
					<tr>
						<td>
		<?php
...
<tr>
						<td class="map_comment">{{ $route->comment }}</td>
