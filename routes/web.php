...
Route::group(["middleware"=>"auth","prefix"=>"/traces/"],function(){
	...
	Route::get("del/{p_id}",["as"=>"traces.del","uses"=>"TracesController@del"]);
	Route::get("upload",["as"=>"traces.upload","uses"=>"TracesController@upload"]);
	Route::Post("save",["as"=>"traces.save","uses"=>"TracesController@save"]);
});
