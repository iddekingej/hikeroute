...
class GPXReader extends Base
{
     ...
     *            Node from which the attribute must be read.
     * @param String $p_name
     ...
     *
     * @param \DOMNode $p_parent
     *            The trkseg node is search in the childeren of the trk node
    ...
    /**
     * The top node is a gpx node.
     * This routine searches for a "trk" node under
     * the GPX node
     *
     * @param \DOMNode $p_parent
     *            The GPX node, the trk node is searched in child nodes of this node.
