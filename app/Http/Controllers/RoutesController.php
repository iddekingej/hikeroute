...
class RoutesController extends Controller
{
	...
	/**
	 * Display input form for inputting new hiking route
	 * 
	...
	/**
	 * Display a list of routes belonging to the loggedin user
	 * 
	 * @return View View with list 
	 */
	function listRoutes()
	{
		return View("routes.list",["routes"=>\Auth::user()->routes()->getResults()]);
	}
	...
	/**
	 * User input data about hiking route after submitting the form
